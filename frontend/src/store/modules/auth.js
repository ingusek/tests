...
const state = {
  authKey: localStorage.getItem('frontend-auth-key') || '',
  refreshAuthKey: localStorage.getItem('frontend-refresh-auth-key') || '',
  loading: false,
  isRegistered: false,
  isLoggedIn: false,
  isPasswordResetRequested: false,
  isPasswordResetted: false,
  user: localStorage.getItem('frontend-auth-key') ? jwtDecode(localStorage.getItem('frontend-auth-key')) : null
};
...
const mutations = {
  ...
  loginSuccess(state, { authKey, refreshAuthKey }) {
    ...
    localStorage.setItem('frontend-auth-key', authKey);
    localStorage.setItem('frontend-refresh-auth-key', refreshAuthKey);
  },
  loginFailure(state) {
    state.loading = false;
  },
  ...
  logout(state) {
    ...
    state.authKey = null;
    state.user = null;
    localStorage.removeItem('frontend-auth-key');
    localStorage.removeItem('frontend-refresh-auth-key');
  },
  clear(state) {
    state.loading = false;
    state.isRegistered = false;
